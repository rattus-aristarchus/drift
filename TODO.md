...
- переписать метод do_food чтобы он работал для любых потребностей; сделать класс need более умным,
чтобы там была информация, какой тип ресурса нужен для удовлетворения потребности, и  поглощает ли 
потребность этот ресурс (напр. одежда не поглощает) 
